...
int main (int argc, char **argv)
{
   ...
   typedef Ring::Element Element;
	...
	RandomDenseStream<Ring, DenseMatrix<Element>::Row> A1_stream (GFq, n, m);
	RandomSparseStream<Ring, SparseMatrix<Element>::Row> A2_stream (GFq, (double) k / (double) n, n, m);

	DenseMatrix<Element> A1 (A1_stream);
	SparseMatrix<Element> A2 (A2_stream);
	...
	DenseMatrix<Element> A3 (A1_stream);
	SparseMatrix<Element> A4 (A2_stream);
	...
	DenseMatrix<Element> A5 (A1_stream);
	SparseMatrix<Element> A6 (A2_stream);
